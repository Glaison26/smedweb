...
// anamnese_altera.php
// Script para gravar os dados Aletrados da anamnese no banco de dados
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    setor='$c_setor', 
    funcao='$c_cargo',
    admissao='$d_data_admissao',
    atividades='$c_atividade',
    jornada='$c_jornada',
    descricao_atividades='$c_descricao_atividades',
    risco_fisico='$c_risco_fisico',
    risco_quimico='$c_risco_quimico', 
    risco_biologico='$c_risco_biologico',
    risco_ergonomico='$c_risco_ergonomico',
    risco_acidentes='$c_risco_acidente',
    motivo_consulta='$c_motivo_consulta',
    queixa_principal='$c_queixa_principal',
    hda='$c_historia_doenca_atual',
    antecedente_hipertensao='$c_antecedente_hipertensao', 
    antecedente_diabete='$c_antecedente_diabetes',
    antecedente_cardiaco='$c_antecedente_cardiovasculares',
    ...
    medicamentos_uso='$c_uso_medicamentos',
    habito_tabagismo='$c_tabagismo',
    etilismo='$c_alcoolismo',
    atividade_fisica='$c_atividade_fisica',
    atividade_fisica_qual='$c_quais_atividades_fisicas',
    atividade_fisica_frequencia='$c_frequencia_atividade_fisica', 
    tabagismo_qtd_dia='$c_qtd_cigarros_dia', 
    tabagismo_tempo='$c_tempo_tabagismo_anos', 
    etilismo_frequencia='$c_qtd_doses_semana',
    usa_epi='$c_uso_epi',
    quais_epi='$c_quais_epi',
    familiar_hipertensao='$c_familiar_hipertensao',
    obs_familiar_hipertensao='$c_obs_familiar_hipertensao',
    familiar_diabetes='$c_familiar_diabetes', 
    obs_familiar_diabetes='$c_obs_familiar_diabetes',
    familiar_cardiaco='$c_familiar_cardiovasculares',
    obs_familiar_cardiaco='$c_obs_familiar_cardiovasculares',
    familiar_cancer='$c_familiar_cancer', 
    obs_familiar_cancer='$c_obs_familiar_cancer',
    familiar_outros='$c_familiar_outras_doencas',
    obs_familiar_outros='$c_obs_familiar_outras_doencas',
    stm_geral='$c_geral', 
    stm_pele='$c_pele',
    stm_cabeca_pescoso='$c_cabeca_pescoco',
    stm_olhos='$c_olhos', 
    stm_ouvidos='$c_ouvidos',
    stm_respiratorio='$c_respiratorio', 
    stm_cardiovascular='$c_cardiovascular',
    stm_gastro='$c_gastrointestinal', 
    stm_geniturario='$c_genitourinario',
    stm_musculo_esqueletico='$c_musculo_esqueletico',
    stm_neurologico='$c_neurologico',
    stm_pisiquico='$c_psiquiatrico',
    exame_pa='$c_pressao_arterial', 
    exame_fc='$c_frequencia_cardiaca', 
    exame_fr='$c_frequencia_respiratoria',
    exame_peso='$c_peso',
    exame_altura='$c_altura',
    exame_imc='$c_imc', 
    exame_ectoscopia='$c_ecotoscopia',
    exame_aparelho_respiratorio='$c_aparelho_respiratorio', 
    exame_aparelho_cardio='$c_aparelho_cardiovascular',
    exame_abdome='$c_aparelho_abdome',
    exame_membros='$c_membros',
    exame_coluna='$c_coluna_vertebral',
    exame_neurologico='$c_exame_neurologico',
    obs_hipertensao='$c_antecedente_hipertensao_obs', 
    obs_diabete='$c_antecedente_diabetes_obs',
    obs_cardiaco='$c_antecedente_cardiovasculares_obs',
    obs_asma_bronquite='$c_antecedente_asma_bronquite_obs',
    obs_renais='$c_antecedente_doencas_renais_obs',
    obs_neurologia='$c_antecedente_doencas_neurologicas_obs',
    obs_psiquiatrico='$c_antecedente_disturbios_psiquiatricos_obs', 
    obs_cancer='$c_antecedentes_cancer_obs',
    obs_alergia='$c_antecedentes_alergias_obs',
    obs_cirurgia='$c_antecedentes_cirurgias_previa_obs',
    conduta_hipotese_diag='$c_hipotese_diagnostica',
    conduta_exames_compl='$c_exames_complementares', 
    conduta='$c_conduta',
    parecer='$c_parecer',
