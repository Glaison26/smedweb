        ...
        <table class="table display table-bordered tabprofissionais">
            ...
            <tbody>
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>
                    <a class='btn btn-info btn-sm' title='Editar Profissionais' href='/smedweb/profissionais_editar.php?id=$c_linha[id]'><span class='glyphicon glyphicon-pencil'></span></a>
