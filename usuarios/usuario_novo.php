    ...
    <div class="container content-box">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <input required type="text" maxlength="120" class="form-control" name="nome" value="<?php echo $c_nome; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-2">
                    <select required class="form-control form-control-lg" id="tipo" name="tipo">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <input type="password" required maxlength="30" class="form-control" name="senha" value="<?php echo $c_senha; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <input type="password" required maxlength="30" class="form-control" name="senha2" value="<?php echo $c_senha2; ?>">
                </div>
            </div>
            <hr>
            <div class="row mb-3">
