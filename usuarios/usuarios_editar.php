...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {  // metodo get para carregar dados no formulário
    ...
    if (!isset($_GET["id"])) {
        header('location: /smedweb/usuarios/usuarios_lista.php');
        exit;
    }
    $c_id = $_GET["id"];
    ...
    <div class="container -my5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-5">
                    <input type="text" required maxlength="120" class="form-control" name="nome" value="<?php echo $c_nome; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                    <input type="text" required maxlength="40" class="form-control" name="login" value="<?php echo $c_login; ?>">
                </div>
            </div>
            <?php
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-2">
                    <select required class="form-control form-control-lg" id="tipo" name="tipo" value="<?php echo $c_tipo; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" required maxlength="120" class="form-control" name="email" value="<?php echo $c_email; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Telefone(*)</label>
                <div class="col-sm-3">
                    <input type="text" required maxlength="120" class="form-control" name="telefone" value="<?php echo $c_telefone; ?>">
                </div>
            </div>
            <hr>
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <input type="password" required maxlength="32" class="form-control" name="senha" value="<?php echo $c_senha; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label">Senha de Confirmação(*)</label>
                <div class="col-sm-3">
                    <input type="password" required maxlength="32" class="form-control" name="senha2" value="<?php echo $c_senha2; ?>">
                </div>
            </div>
            <hr>
            <div class="row mb-3">
