...
<body>
     <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/smedweb/cadastros/componentes/componentes_excluir.php?id=" + id;
            }
        }
    </script>
                ...
                <div class="modal-body">
                    ...
                    <form id="frmaddcomponente" action="">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input type="text" requered class="form-control" id="adddescricaoField" name="adddescricaoField">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="col-md-3 form-label">Grupo (*)</label>
                            <div class="col-sm-7">
                                <select class="form-control form-control-lg" id="addgrupoField" name="addgrupoField" requered>
                                    <option></option>
                                    <?php
