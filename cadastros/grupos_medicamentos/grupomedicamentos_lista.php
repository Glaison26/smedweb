...
<body>
    ...
    <div class="panel panel-primary class">
        <div class="panel-heading text-center">
            ...
            <h5>Lista de Grupos de Medicamentos<h5>
        </div>
    </div>
    <br>
    <div class="container -my5">
        ...
        <hr>
        <table class="table display table-bordered tabgrupos">
            <thead class="thead">
                <tr class="info">
                    <th scope="col">No.</th>
            ...
            <tbody>
                ...
                $c_sql = "SELECT grupos_medicamentos.id, grupos_medicamentos.descricao" .
                    " FROM grupos_medicamentos" .
                    " ORDER BY grupos_medicamentos.descricao";
