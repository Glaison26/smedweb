<?php
// recorta dados da lixeira para as seções com os dados do paciente
session_start();
...
// rotina de edição
$c_id = $_GET['id'];
$c_sql_dados = "select * from lixeira_agenda where id='$c_id'";
...
$c_descricao = "Recorte da lixeira de consulta para " . $_SESSION['nomepac'] . " no dia " . $c_data_formatada_agenda .
" às " . $c_linha['horario'];
