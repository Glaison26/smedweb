...
$c_cpf = "";
$d_datanasc = "";
// pego data atual do sistema
$d_dataprimeira = date('Y-m-d');
$c_matricula = "";
$c_cor = "";
$c_classificacao = "";
$c_cor = "";
...
if ($_SESSION['incagenda'] == true) {
    ...
    // pego a descricção do convênio
    $c_sql_convenio = "SELECT convenios.id, convenios.nome FROM convenios where convenios.id='$c_convenio'";
    $result = $conection->query($c_sql_convenio);
    $c_linha = $result->fetch_assoc();
    // jogo o nome do convênio na variavel
    $c_convenio = $c_linha['nome'];
            ...
            <form method="post" class="form-horizontal">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="dados_apresentacao">
                        <div style="padding-top:20px;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-form-label"><span>Selecione Genero</span></label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" maxlength="150" class="form-control" id="endereco" name="endereco" value="<?php echo $c_endereco; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Bairro</label>
                                <div class="col-sm-5">
                                    <input type="text" maxlength="100" class="form-control" id="bairro" name="bairro" value="<?php echo $c_bairro; ?>">
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" maxlength="100" class="form-control" id="cidade" name="cidade" value="<?php echo $c_cidade; ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-2">
                                <input type="date" required placeholder="dd/mm/yyyy" onkeypress="mascaraData(this)" class="form-control" id="dataprimeira" name="dataprimeira" value="<?php echo $d_dataprimeira; ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Procedência</label>
                            <div class="col-sm-5">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Indicação</label>
                            <div class="col-sm-5">
                    ...
                    <div role="tabpanel" class="tab-pane" id="dados_contatos">
                        <div style="padding-top:20px;">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">*Convênio</label>
                                <div class="col-sm-3">
                            ...
                            <hr>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">*Fone 1</label>
                                <div class="col-sm-2">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Fone 2</label>
                                <div class="col-sm-2">
